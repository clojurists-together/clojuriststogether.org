...
#2009: new :var-same-name-except-case linter: warn when vars have names that differ only in case (important for AOT compilation and case-insensitive filesystems)
#1269: warn on :jvm-opts in top level of deps.edn
#2003: detect invalid arity call for function passed to update, update-in, swap!, swap-vals!, send, send-off, and send-via
...
clojurescript:
PR 202: a macroexpand fix
PR 203: a symbol optimization fix
...
#1541: respect bb.edn adjacent to invoked file. This eases writing system-global scripts from projects without using bbin. See docs.
See the complete CHANGELOG.
...
Discuss this post here.  Tagged: clojure oss updates  ,br>
—
### Sean Corfield  
...
One of my major open-source goals for this year is the release of a new **data security framework**, currently [planned](https://www.taoensso.com/clojure/2023) for August.
