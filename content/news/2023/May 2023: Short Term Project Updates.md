...
Update: 2 May 2023; Final Report

Funding Round: Q1 2023

###  Interactive Links & Homepage, Book Updates, Viewer Customization  
...
a given doc by entering it in the browser's address bar.  

Use these features to build a new welcome page that gives more useful information,
...
Wikidata-style links to other notebooks and vars are also on the roadmap.  

* **👁 Improved support for customization of viewer options**  
...
per-result consistently using the same keys.  

* **🍒 Experimental support for cherry for compiling viewer fns**  
...
viewer fns since it removes the interpretation overhead.  

* **📖 Book Updates**  

Documented the [Viewer Customization Options](https://github.clerk.garden/nextjournal/book-of-clerk/commit/c47477cb3ca72740de82c9fd3ddcb384f7c7eeb9/#customizations) in the Book of Clerk.  

    

* **🐞 Smaller Bugfixes & Improvements**  

We plan to follow up with a v0.14 release shortly. 
What we had planned but didn't yet get around to is documenting how to use Clerk 
...
Update: 15 May 2023; Final Report
...
for people that do not have MELPA configured.  

## Project Exercism: Bobbi Towers  

Update 29 April 2023: Final Report
...
Update: 4 May 2023; Final Report

Funding Round: Q3 2022
...
the [ClojureScript Podcast with Jacek Schae Ep

30](https://podcasts.apple.com/us/podcast/s4-e30-testing-wtih-arne-brasseur-part-2/id1461500416?i=1000523138440&l=da)

(since renamed to ClojureStream) where Arne and Jacek talk at length about these

Topics.  

April also saw the first release of

[Plenish](https://github.com/lambdaisland/plenish), a tool we (the Gaiwan Team)
...
analytical workloads to run on Postgres. For a, watch [Arne's talk about

it](https://www.youtube.com/watch?v=BxK44tRhKMQ). A related project is EmbedKit,
...
Finally we released a new version of Ornament, our css-in-clj(s) styled

component libraries, improving support for Tailwind 3 classnames.
